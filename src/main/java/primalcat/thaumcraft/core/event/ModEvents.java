package primalcat.thaumcraft.core.event;
...
import primalcat.thaumcraft.common.command.AspectCommand;
import primalcat.thaumcraft.common.command.TargetCommand;
...
//                event.addCapability(new ResourceLocation(Thaumcraft.MOD_ID, "properties"), new PlayerThirstProvider());
                event.addCapability(new ResourceLocation(Thaumcraft.MODID, "properties"), new PlayerAspectsProvider());
            }
        }
    }
