...
import primalcat.thaumcraft.common.block.node.NodeEntity;
...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<NodeEntity>> NODE = BLOCK_ENTITY_TYPES.register("node", () -> BlockEntityType.Builder.of(NodeEntity::new, BlockRegistry.NODE.get()).build(null));
